...
# This is comment for main branch
...
# def parse_datetime_ordinary(str_datetime):
#     return datetime.strptime(str_datetime, '%Y-%m-%dT%H:%M:%S%z')


def parse_datetime_with_ciso8601(str_datetime):
...
#
#
# def parse_datetime_with_regex(str_datetime):
...
#
#
# def parse_datetime_directly(str_datetime):
#     """
...
parse_datetime = parse_datetime_with_ciso8601
